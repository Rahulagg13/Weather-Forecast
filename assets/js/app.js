...
export const updateWeather = function (lat, lon) {
  ...
  fetchData(url.currrentWeather(lat, lon), function (currentWeather) {
    ...
    card.innerHTML = `
      ...
      <div class="weapper">
          <p class="heading">${(parseInt(temp) - 273).toFixed(
            0
          )}&deg;<sup>c</sup></p>
    ...
    fetchData(url.airPollution(lat, lon), function (airPollution) {
      ...
      card.innerHTML = `                        
        ...
        module.aqiTxt[aqi].message
      }">${module.aqiTxt[aqi].level}</span>
            </div>
            ...
            <div class="card card-sm highlight-card">
                ...
                <div class="wrapper">
                    ...
                    <p class="title-1">${(parseInt(feels_like) - 273).toFixed(
                      0
                    )}&deg;<sup>c</sup></p>
                </div>
            </div>
    ...
    fetchData(url.forcast(lat, lon), function (forcast) {
      const {
        list: forecastList,
        city: { timezone },
      } = forcast;
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        tempLi.innerHTML = `
          <div class="card card-sm slider-card">
            ...
            <p class="body-3">${(parseInt(temp) - 273).toFixed(0)}&deg;</p>
          </div>
        `;
        ...
        windLi.innerHTML = `
          <div class="card card-sm slider-card">
            ...
            <img src="./assets/images/weather_icons/direction.png" width="48" height="48"
                alt="" loading="lazy" class="weather-icon" style="transform:rotate(${
                  windDirection - 180
                }deg)">
      ...
      forecastSection.innerHTML = `
        <h2 class="title-2" id="forecast-label">5 Days Forcast</h2>
      ...
      for (let i = 7, len = forecastList.length; i < len; i += 8) {
        ...
        li.innerHTML = `
          <div class="icon-wrapper">
            ...
            <span class="span">
                <p class="title-2">${(parseInt(temp_max) - 273).toFixed(
                  0
                )}&deg;<sup>c</sup></p>
            </span>
          </div>
